...
function hesapla() {
    ...
    console.log(JSON.stringify(mode[0]));
    localStorage.setItem("mode", JSON.stringify(mode[0]));
...
function goster() {
    ...
    document.getElementById("Mod").innerHTML = 'Mod: ' + mode + ' Frekans: ' + localStorage.getItem('frekans');
